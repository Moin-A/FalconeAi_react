  ...
  return (
    <div className="h-full w-full">
      ...
      <article class="max-w-prose mx-auto py-8">
        <h1 class="text-2xl font-bold">About The game</h1>
        <h3 class="text-2xl font-bold">Rules #</h3>
        <p class="mt-6">
          This Game is game of chance, you player needs to find princess
        </p>
        ...
        <p class="mt-4">
          ...
          mauris. Nunc nec laoreet ipsum. Sed vel est a eros sagittis vulputate.
          Proin cursus ut mauris vel commodo. Sed non sapien metus.
        </p>
        <p class="mt-4">
          Nunc aliquet maximus ante, quis malesuada orci sagittis vel. Nunc non
          porta purus, ultricies rhoncus nulla. Aenean laoreet tortor nec risus
          fringilla posuere. Quisque eu lacinia dolor, in luctus leo. Aenean non
          turpis ac ipsum fermentum faucibus. Pellentesque fringilla ante a ex
          mollis, non scelerisque orci tempor. Sed non dapibus dolor, ac euismod
          turpis. Integer eu quam nibh. Ut suscipit lacinia sollicitudin.
          Pellentesque habitant morbi tristique senectus et netus et malesuada
          fames ac turpis egestas. Maecenas rutrum vestibulum mauris, sed mattis
          tellus maximus in. Nullam imperdiet enim nec nisi euismod, ut accumsan
          odio gravida. Nunc eu augue a dui porta fringilla sed at ex. Cras
          pellentesque suscipit porttitor. Nunc non ullamcorper nibh. Praesent
          purus libero, congue non laoreet sed, dapibus vel turpis.
        </p>
      </article>
    </div>
  );
